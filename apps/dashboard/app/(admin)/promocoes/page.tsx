...
import { PromocaoLeadsTab } from '@/components/promocao-leads-tab'
...
export default function PromocoesPage() {
  ...
  const [tab, setTab] = useState<'promos' | 'leads'>('promos')
              ...
              {sorted.map((p, idx) => (
                ...
                >
                  ...
                  <div className="hidden text-right text-xs sm:block">
                    ...
                    <p>
                      <span className="font-medium">{p.leads_count}</span>{' '}
