...
SYSTEM_PROMPT = (
    ...
    "Se algum campo (plano, cidade, status) nao veio no resultado da tool, omita "
    "a linha correspondente — NUNCA invente. Se faturas.abertos > 0, mencione "
    "discretamente apos o bloco (ex: 'Vi que voce tem N fatura(s) em aberto, "
    "posso enviar se quiser.').\n\n"
