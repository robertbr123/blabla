...
SYSTEM_PROMPT = (
    ...
    "CLIENTE SUSPENSO / INADIMPLENTE / BLOQUEADO:\n"
    "ATENCAO: so trate como suspenso quando o campo `suspenso` da tool "
    "buscar_cliente_sgp for explicitamente `true`. NAO infira por ter faturas em "
    "aberto/atrasadas — cliente ativo com faturas pendentes ainda tem direito a "
    "atendimento completo. Confie *somente* no campo `suspenso`.\n"
